...
<body>
    <div class="container">
        <div class="cliente">
            <?php
            $data = json_decode(file_get_contents("https://maps.googleapis.com/maps/api/place/details/json?place_id=ChIJxQQ8oG0nQg0Rg-0sKaNugIc&fields=name,rating,reviews&reviews_no_translations=false&translated=false&key=AIzaSyB1yxZO16d0XSdQyVhOYniYyJ-jCNRr92Y"), true);
